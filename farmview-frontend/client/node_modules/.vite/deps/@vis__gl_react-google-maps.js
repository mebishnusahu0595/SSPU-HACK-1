...
function useMapInstances() {
  ...
  const removeMapInstance = (id = "default") => {
    setMapInstances((_a) => {
      var _b = id;
      _a[_b];
      var remaining = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
      return remaining;
    });
  };
...
function useGoogleMapsApiLoader(props) {
  ...
  const librariesString = (0, import_react.useMemo)(() => libraries === null || libraries === void 0 ? void 0 : libraries.join(","), [libraries]);
  const serializedParams = (0, import_react.useMemo)(() => JSON.stringify(Object.assign({ apiKey, version }, otherApiParams)), [apiKey, version, otherApiParams]);
  const importLibrary = (0, import_react.useCallback)((name) => __awaiter(this, void 0, void 0, function* () {
    var _a;
    ...
    () => {
      (() => __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          if (params.channel === void 0 || params.channel < 0 || params.channel > 999)
          ...
          yield GoogleMapsApiLoader.load(params, (status2) => setStatus(status2));
...
function useInternalUsageAttributionIds(props) {
  const internalUsageAttributionIds = (0, import_react.useMemo)(() => props.disableUsageAttribution ? null : DEFAULT_INTERNAL_USAGE_ATTRIBUTION_IDS, [props.disableUsageAttribution]);
...
var Pin = (props) => {
  var _a;
  const advancedMarker = (_a = (0, import_react.useContext)(AdvancedMarkerContext)) === null || _a === void 0 ? void 0 : _a.marker;
